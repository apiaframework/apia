...
describe Moonstone::Scalars::Date do
  ...
  context '.parse' do
    ...
    it 'should raise a parse error if the given date is not a valid date string' do
      expect { Moonstone::Scalars::Date.parse('2021-03-33') }.to raise_error(Moonstone::ParseError)
      expect { Moonstone::Scalars::Date.parse('blah') }.to raise_error(Moonstone::ParseError)
      expect { Moonstone::Scalars::Date.parse('20-03-33') }.to raise_error(Moonstone::ParseError)
      expect { Moonstone::Scalars::Date.parse('invalid') }.to raise_error(Moonstone::ParseError)
      expect { Moonstone::Scalars::Date.parse(0) }.to raise_error(Moonstone::ParseError)
      expect { Moonstone::Scalars::Date.parse(1244) }.to raise_error(Moonstone::ParseError)
      expect { Moonstone::Scalars::Date.parse(true) }.to raise_error(Moonstone::ParseError)
    end
  end
end
