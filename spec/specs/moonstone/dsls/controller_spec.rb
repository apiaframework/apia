...
describe Moonstone::DSLs::Controller do
  subject(:controller) { Moonstone::Definitions::Controller.new('TestController') }
  subject(:dsl) { Moonstone::DSLs::Controller.new(controller) }
