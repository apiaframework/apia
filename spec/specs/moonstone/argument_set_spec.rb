...
describe Moonstone::ArgumentSet do
  ...
  context '.collate_objects' do
    it 'should add types from arguments to the set' do
      ...
      book_as = Moonstone::ArgumentSet.create('ExampleSet') do
  ...
  context '#initialize' do
    ...
    it 'should be able to nest argument sets' do
      as1 = Moonstone::ArgumentSet.create('ExampleSet') do
        argument :name, type: :string
      end
      as2 = Moonstone::ArgumentSet.create('ExampleSet') do
      ...
      expect(instance[:user]).to be_a Moonstone::ArgumentSet
    ...
    it 'should know about nested arguments in errors' do
      ...
      as3 = Moonstone::ArgumentSet.create('ExampleSet') do
        argument :age, type: :integer
    ...
    it 'should raise an error if initialized with anything other than a hash' do
      as = Moonstone::ArgumentSet.create('ExampleSet')
      expect { as.new({}) }.to_not raise_error
      expect { as.new([]) }.to raise_error Moonstone::RuntimeError
