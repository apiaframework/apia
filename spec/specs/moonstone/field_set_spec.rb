...
describe Moonstone::FieldSet do
  subject(:field_set) { Moonstone::FieldSet.new }

  context '#generate_hash' do
    it 'should set fields to nil if they are nil' do
      field = Moonstone::Definitions::Field.new(:name)
      field.type = :string
    ...
    it 'should not include fields that are not supposed to be included' do
      ...
      field = Moonstone::Definitions::Field.new(:age)
      field.type = :integer
    ...
    it 'should not include fields with a type that does not allow its inclusion' do
      ...
      field = Moonstone::Definitions::Field.new(:thing)
      field.type = type
      field_set.add field

      field = Moonstone::Definitions::Field.new(:number)
      field.type = :integer
      field_set.add field
    ...
    it 'should set a field to the hash of an underlying type' do
      ...
      field = Moonstone::Definitions::Field.new(:user)
      field.type = type
      field_set.add field
