...
describe Apia::RouteSet do
  ...
  context '#find' do
    ...
    it 'should find multiple routes if they are the same' do
      route1 = route_set.add(Apia::Route.new('users'))
      route2 = route_set.add(Apia::Route.new('users'))
